...
def Register(request):
    if request.method == 'POST' :
        ...
        if form.is_valid():
            ...
            msg_plain = "test"
            is_sent = True
            msg_html = render_to_string('Verification_letter.html',{'uname': uname, 'vlink':vlink})
            send_mail('Verification Mail From b07902001',msg_plain,'b07902000@ntu.edu.tw',[email],html_message=msg_html)
